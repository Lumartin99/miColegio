...
public class AsyncModProfesor extends AsyncTask<String, Void, String> {

    private String idUsers;

    public AsyncModProfesor() {
    }

    @Override
    protected String doInBackground(String... arg0) {
        String idUsers = arg0[0];
        String name = arg0[1];
        String email = arg0[2];
        String telefono = arg0[3];;
        ...
        try {
            ...
            link = "http://micolegio.no-ip.org/modificarProfesor.php";
